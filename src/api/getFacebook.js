...
const fb = "https://graph.facebook.com/v5.0";
const pageId = "245518842150454";
const accessToken =
  "access_token=1090962680953288|493fd3b7d2a22a8fdbc1915190748104";

function getInfo() {
  let fields = ["location", "phone"];
...
function getEvents(limit) {
  ...
  return axios.get(
    `${fb}/${pageId}/events?limit=${limit}&time_filter=upcoming&fields=${fields.join(
      ","
    )}&${accessToken}`
  );
}
